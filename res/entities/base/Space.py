...
class Space(shyloo.Base, GameObject):
	"""
	...
	def createSpawnPointDatas(self):
		...
		if(len(self.spaceResName) == 0 or not shyloo.hasRes(res)):
			return
			
		res = shyloo.getResFullPath(res)
	...
	def spawnOnTimer(self, tid):
		...
		shyloo.createBaseAnywhere("SpawnPoint", 
