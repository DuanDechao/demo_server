...
class GameObject:
	...
	def getCurrSpaceBase(self):
		...
		"""
		return shyloo.globalData["space_%i" % self.spaceID]
	...
	def getCurrSpace(self):
		...
		return shyloo.entities.get(spaceBase.id, None)
		
	def getSpaces(self):
		"""
		获取场景管理器
		"""
		return shyloo.globalData["Spaces"]
	...
	def startDestroyTimer(self):
		...
		if self.isState(GlobalDefine.ENTITY_STATE_DEAD):
			self.addTimer(5, 0, "onTimer", SCDefine.TIMER_TYPE_DESTROY)
